// Link - https://leetcode.com/contest/weekly-contest-417/problems/count-of-substrings-containing-every-vowel-and-k-consonants-ii/description/
    ...
    int countOfSubstrings(string word, int k) {
        ...
        for (int i = 0; i <= n - k - 5; i++) {
            ...
            while (true) {
                ...
                else if (p.first == 1 && p.second > k) break;
                j++;
            }
        }
        return result;
